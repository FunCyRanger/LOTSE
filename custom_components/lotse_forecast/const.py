...
NODE_KEY_META: dict[str, dict] = {
    ...
    "bc":  {"unit": "kWh", "device_class": "energy",    "state_class": "measurement",     "name": "bC"},
...
COMBINED_KEY_META: dict[str, dict] = {
    ...
    "combined_mesh_battery_capacity": {"unit": "kWh", "device_class": "energy", "state_class": "measurement", "name": "Combined Mesh Battery Capacity"},
