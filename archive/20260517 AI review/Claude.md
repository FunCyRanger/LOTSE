...
## Project Review: Feasibility & Errors
...
**Economic fairness check (FR-06) without algorithm:** The requirement that no household be worse off than without the system is well-intentioned — but there is neither a data structure nor a calculation method for it. This needs to be defined before Phase 2 implementation.
